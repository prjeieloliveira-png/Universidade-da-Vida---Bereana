...
SELECT
    ...
    COALESCE(MAX(CASE WHEN l.session_number = 1 THEN a.present END), false) AS s1,
    COALESCE(MAX(CASE WHEN l.session_number = 2 THEN a.present END), false) AS s2,
    COALESCE(MAX(CASE WHEN l.session_number = 3 THEN a.present END), false) AS s3,
    COALESCE(MAX(CASE WHEN l.session_number = 4 THEN a.present END), false) AS s4,
    COALESCE(MAX(CASE WHEN l.session_number = 5 THEN a.present END), false) AS s5,
    COALESCE(MAX(CASE WHEN l.session_number = 6 THEN a.present END), false) AS s6,
    COALESCE(MAX(CASE WHEN l.session_number = 7 THEN a.present END), false) AS s7,
    COALESCE(MAX(CASE WHEN l.session_number = 8 THEN a.present END), false) AS s8,
    COALESCE(MAX(CASE WHEN l.session_number = 9 THEN a.present END), false) AS s9,
